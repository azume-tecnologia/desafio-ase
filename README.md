...
3. **Instalando dependências**: Instale as dependências usando o comando `npm i --legacy-peer-deps` (a flag --legacy-peer-deps é necessária para instalar alguns pacotes corretamente)
4. Crie uma nova branch para fazer seus commits. A branch deve ser nomeada dessa forma: `desafio-mern-{nome_do_candidato}`
5. **Iniciando o servidor**: Inicie o servidor usando o comando `npm run dev`
...
3. **Instalando dependências**: Instale as dependências usando o comando `npm i --legacy-peer-deps` (a flag --legacy-peer-deps é necessária para instalar alguns pacotes corretamente)
4. Crie uma nova branch para fazer seus commits. A branch deve ser nomeada dessa forma: `desafio-mern-{nome_do_candidato}`
5. **Iniciando o servidor**: Inicie a aplicação usando o comando `npm run dev`
